...
2. [使用 LLM API 开发应用](./C2/) @毛雨
   1. [基本概念](./C2/C2.md#21-基本概念)
   2. [使用 LLM API](./C2/C2.md#22-使用-llm-api)
        - ChatGPT
        - 文心一言
        - 讯飞星火
        - 智谱 GLM
   3. [Prompt Engineering](./C2/C2.md#23-prompt-engineering)
3. [搭建知识库](./C3/) @娄天奥
   1. [词向量及向量知识库介绍](./C3/C3.md#31-向量及向量知识库)
   2. [使用 Embedding API](./C3/C3.md#32-使用embedding-api)
   3. [数据处理：读取、清洗与切片](./C3/C3.md#33-数据处理)
   4. [搭建并使用向量数据库](./C3/C3.md#34-搭建并使用向量数据库)
4. [构建 RAG 应用](./C4/) @徐虎
   1. [将 LLM 接入 LangChain](./C4/C4.md#41-将llm-接入-langchain)
        - ChatGPT
        - 文心一言
        - 讯飞星火
        - 智谱 GLM
   2. [基于 LangChain 搭建检索问答链](./C4/C4.md#42-构建检索问答链)
   3. [基于 Streamlit 部署知识库助手](./C4/C4.md#43-部署知识库助手)
5. [系统评估与优化](./C5/) @邹雨衡
   1. [如何评估 LLM 应用](./C5/C5.md#51-如何评估-llm-应用)
   2. [评估并优化生成部分](./C5/C5.md#52-评估并优化生成部分)
   3. [评估并优化检索部分](./C5/C5.md#53-评估并优化检索部分)
